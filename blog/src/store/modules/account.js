/**
 * Created by wzs28150 on 2017/5/31.
 */
...
const state = {
  ...
  auth: {
    ...
    clientID: '2ed386796c20826d3287',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: 'a31fcc1ff5b3b958b5cf30488512136cc853a666'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'wangqingzhong888',  // 修改成你自己的 GitHub 账号
  copyright: '2018 - 2019',  // 修改成你自己的
  recordNumber: null,  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'wangqingzhong888/wangqingzhong888.github.io',  // 记录 Issue 的仓库的全名「用户名/仓库名」
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/wangqingzhong888'  // 第三方站点的 url
    },
    {
